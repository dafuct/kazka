...
export const en: Locale = {
  ...
  settings: {
    ...
    cancelMonobankConfirmBody: 'No further charges will be made. Pro continues until {date}. You can resubscribe anytime with the same card or a new one.',
    cancelConfirmYes: 'Yes, cancel',
    cancelConfirmNo: 'Keep it',
    cancelled: 'Subscription cancelled.',
    cancelledNotice: 'Subscription cancelled — Pro active until {date}',
  ...
  showcase: {
    ...
    cta: {
      ...
      subtitle: 'Free — 5 tales every month. With their real name, favourite heroes, and illustrations.',
